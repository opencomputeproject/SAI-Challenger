...
vlan_attrs = [
    ...
    ("SAI_VLAN_ATTR_UNKNOWN_NON_IP_MCAST_OUTPUT_GROUP_ID",      "sai_object_id_t",                  "0x0"),
    ("SAI_VLAN_ATTR_UNKNOWN_IPV4_MCAST_OUTPUT_GROUP_ID",        "sai_object_id_t",                  "0x0"),
    ("SAI_VLAN_ATTR_UNKNOWN_IPV6_MCAST_OUTPUT_GROUP_ID",        "sai_object_id_t",                  "0x0"),
    ("SAI_VLAN_ATTR_UNKNOWN_LINKLOCAL_MCAST_OUTPUT_GROUP_ID",   "sai_object_id_t",                  "0x0"),
    ("SAI_VLAN_ATTR_INGRESS_ACL",                               "sai_object_id_t",                  "0x0"),
    ("SAI_VLAN_ATTR_EGRESS_ACL",                                "sai_object_id_t",                  "0x0"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("SAI_VLAN_ATTR_STP_INSTANCE",                              "0x0"),
        ...
        ("SAI_VLAN_ATTR_UNKNOWN_NON_IP_MCAST_OUTPUT_GROUP_ID",      "0x0"),
        ("SAI_VLAN_ATTR_UNKNOWN_IPV4_MCAST_OUTPUT_GROUP_ID",        "0x0"),
        ("SAI_VLAN_ATTR_UNKNOWN_IPV6_MCAST_OUTPUT_GROUP_ID",        "0x0"),
        ("SAI_VLAN_ATTR_UNKNOWN_LINKLOCAL_MCAST_OUTPUT_GROUP_ID",   "0x0"),
        ("SAI_VLAN_ATTR_INGRESS_ACL",                               "0x0"),
        ("SAI_VLAN_ATTR_EGRESS_ACL",                                "0x0"),
        ("SAI_VLAN_ATTR_META_DATA",                                 "0"),
        ("SAI_VLAN_ATTR_UNKNOWN_UNICAST_FLOOD_CONTROL_TYPE",        "SAI_VLAN_FLOOD_CONTROL_TYPE_ALL"),
        ("SAI_VLAN_ATTR_UNKNOWN_UNICAST_FLOOD_GROUP",               "0x0"),
        ("SAI_VLAN_ATTR_UNKNOWN_MULTICAST_FLOOD_CONTROL_TYPE",      "SAI_VLAN_FLOOD_CONTROL_TYPE_ALL"),
        ("SAI_VLAN_ATTR_UNKNOWN_MULTICAST_FLOOD_GROUP",             "0x0"),
        ("SAI_VLAN_ATTR_BROADCAST_FLOOD_CONTROL_TYPE",              "SAI_VLAN_FLOOD_CONTROL_TYPE_ALL"),
        ("SAI_VLAN_ATTR_BROADCAST_FLOOD_GROUP",                     "0x0"),
